...
def test_robotraconteur_tcp_tls():
    ...
    obj = _testobj_impl()
    obj2 = _testobj_impl()
    ctx = node1.RegisterService("test_service", "experimental.tls_test.testobj", obj)
    ...
    authdata = "testuser1 0b91dec4fe98266a03b136b59219d0d6 objectlock " + str(node3.NodeID) + "\n" \
        ...
        + "testsuperuser 503ed776c50169f681ad7bbc14198b68 objectlock,objectlockoverride " + str(node3.NodeID) + "\n"
    ...
    ctx_secure = node1.RegisterService("test_service_secure", "experimental.tls_test.testobj", obj2, s)
