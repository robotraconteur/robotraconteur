                       ...
                       public RR_ENABLE_SHARED_FROM_THIS<testroot3_impl>
{
  public:
    ...
    RR_OVIRTUAL void set_testenum1_prop(com::robotraconteur::testing::TestService3::testenum1::testenum1 value)
        RR_OVERRIDE;
    ...
    RR_OVIRTUAL RR_INTRUSIVE_PTR<com::robotraconteur::testing::TestService3::teststruct3> get_teststruct3_prop()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_teststruct3_prop(
        const RR_INTRUSIVE_PTR<com::robotraconteur::testing::TestService3::teststruct3>& value) RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::PodArrayMemory<com::robotraconteur::testing::TestService3::testpod2> >
    get_pod_m1() RR_OVERRIDE;
    RR_OVIRTUAL RR_SHARED_PTR<
        RobotRaconteur::PodMultiDimArrayMemory<com::robotraconteur::testing::TestService3::testpod2> >
    get_pod_m2() RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Generator<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<uint8_t> >,
    ...
    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Generator<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<uint8_t> >, void> >
    gen_func2(const std::string& name) RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Generator<void, RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<uint8_t> > > >
    ...
    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > > get_p1()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_p1(
        const RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > > get_p2()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_p2(
        const RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<int32_t> > > >
    get_p3() RR_OVERRIDE;
    RR_OVIRTUAL void set_p3(
        const RR_SHARED_PTR<RobotRaconteur::Pipe<RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<int32_t> > > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Wire<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > > get_w1()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_w1(
        const RR_SHARED_PTR<RobotRaconteur::Wire<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::Wire<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > > get_w2()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_w2(
        const RR_SHARED_PTR<RobotRaconteur::Wire<RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<int32_t> > > >& value)
        RR_OVERRIDE;
    ...
    RR_OVIRTUAL void set_testnamedarray2(const com::robotraconteur::testing::TestService3::transform& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRNamedArray<com::robotraconteur::testing::TestService3::transform> >
    get_testnamedarray3() RR_OVERRIDE;
    RR_OVIRTUAL void set_testnamedarray3(
        const RR_INTRUSIVE_PTR<RobotRaconteur::RRNamedArray<com::robotraconteur::testing::TestService3::transform> >&
            value) RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<
        RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> >
    get_testnamedarray4() RR_OVERRIDE;
    RR_OVIRTUAL void set_testnamedarray4(
        const RR_INTRUSIVE_PTR<
            RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<
        RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> >
    get_testnamedarray5() RR_OVERRIDE;
    RR_OVIRTUAL void set_testnamedarray5(
        const RR_INTRUSIVE_PTR<
            RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::NamedArrayMemory<com::robotraconteur::testing::TestService3::transform> >
    ...
    RR_OVIRTUAL void set_c2(const RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::cdouble> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::cdouble> > get_c3() RR_OVERRIDE;
    RR_OVIRTUAL void set_c3(const RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::cdouble> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRArray<RobotRaconteur::cdouble> > > get_c5()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_c5(
    ...
    RR_OVIRTUAL void set_c8(const RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::cfloat> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::cfloat> > get_c9() RR_OVERRIDE;
    RR_OVIRTUAL void set_c9(const RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::cfloat> >& value)
        RR_OVERRIDE;
    ...
    RR_OVIRTUAL void set_b2(const RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::rr_bool> > get_b3() RR_OVERRIDE;
    RR_OVIRTUAL void set_b3(const RR_INTRUSIVE_PTR<RobotRaconteur::RRMultiDimArray<RobotRaconteur::rr_bool> >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> > > get_b4()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_b4(
        const RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> > > get_b5()
        RR_OVERRIDE;
    RR_OVIRTUAL void set_b5(
        const RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> > >& value)
        RR_OVERRIDE;

    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::RRList<RobotRaconteur::RRMultiDimArray<RobotRaconteur::rr_bool> > >
    get_b6() RR_OVERRIDE;
    RR_OVIRTUAL void set_b6(
...
class obj4_impl : public virtual com::robotraconteur::testing::TestService3::obj4
{
  public:
    ...
    RR_OVIRTUAL RR_SHARED_PTR<com::robotraconteur::testing::TestService1::sub3> get_o3_1(const std::string& ind)
        RR_OVERRIDE
    {
