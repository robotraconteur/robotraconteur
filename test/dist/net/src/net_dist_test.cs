...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        using (var node_setup = new ServerNodeSetup("experimental.distfiles_test", 0, args))
        {
            ...
            var c = (experimental.distfiles_test.DistfilesTest)RobotRaconteurNode.s.ConnectService($"rr+tcp://localhost:{port}/?service=DistfilesTest");
            c.c = 5;
            if(c.add(1, 2) != 8) throw new Exception("Invalid result");
