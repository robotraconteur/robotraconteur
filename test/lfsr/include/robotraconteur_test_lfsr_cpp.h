...
class LFSRSeqGen
{
  ...
  public:
    LFSRSeqGen(uint32_t seed) { lfsr = seed; }
    ...
    {
        RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::rr_bool> > ret =
            RobotRaconteur::AllocateRRArray<RobotRaconteur::rr_bool>(len);
        for (size_t i = 0; i < len; i++)
        {
            (*ret)[i] = NextBool();
        }
    ...
    {
        RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::cfloat> > ret =
            RobotRaconteur::AllocateRRArray<RobotRaconteur::cfloat>(len);
        for (size_t i = 0; i < len; i++)
        {
            (*ret)[i] = NextCFloat();
        }
    ...
    {
        RR_INTRUSIVE_PTR<RobotRaconteur::RRArray<RobotRaconteur::cdouble> > ret =
            RobotRaconteur::AllocateRRArray<RobotRaconteur::cdouble>(len);
        for (size_t i = 0; i < len; i++)
        {
            (*ret)[i] = NextCDouble();
        }
    ...
    {
        return RR_STATIC_POINTER_CAST<RobotRaconteur::RRArray<T> >(
            NextArrayByType(RobotRaconteur::RRPrimUtil<T>::GetTypeID(), len));
    }
    ...
    {
        return RR_STATIC_POINTER_CAST<RobotRaconteur::RRArray<T> >(
            NextArrayByTypeVarLen(RobotRaconteur::RRPrimUtil<T>::GetTypeID(), max_len));
    }
};
} // namespace test
} // namespace RobotRaconteur
