...
extern "C"
{
     ...
     * @return uint32_t
     */
    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_initkey(uint32_t seed, const char* key,
                                                                           uint32_t key_len);
    ...
    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_next_cfloat(uint32_t lfsr, float* r_val_out,
                                                                               float* i_val_out);
    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_next_cdouble(uint32_t lfsr, double* r_val_out,
                                                                                double* i_val_out);

    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_next_char(uint32_t lfsr, char* val_out);

    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_next_len(uint32_t lfsr, size_t max_len,
                                                                            size_t* len_out);

    ROBOTRACONTEUR_TEST_LFSR_API uint32_t robotraconteur_test_lfsr_next_dist(uint32_t lfsr, uint32_t min_,
                                                                             uint32_t max_, uint32_t* val_out);
