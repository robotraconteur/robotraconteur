...
public class testroot3_impl implements testroot3
{
	...
	PodMultiDimArrayMemory<testpod2[]> m_pod_m2 = new PodMultiDimArrayMemory<testpod2[]>(new PodMultiDimArray(new int[] { 3, 3 }, new testpod2[9]));
	@Override
	...
	NamedMultiDimArrayMemory<transform[]> m_namedarray_m2 = new NamedMultiDimArrayMemory<transform[]>(new NamedMultiDimArray(new int[] { 3, 3 }, new transform[9]));
	...
	public void set_c1(CDouble value) {
        ...
        if (!value.equals(c1_2)) throw new RuntimeException();
	...
	public void set_c7(CSingle value) {
        ...
        if (!value.equals( c7_2)) throw new RuntimeException();
