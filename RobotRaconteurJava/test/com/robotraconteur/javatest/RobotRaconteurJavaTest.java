...
public class RobotRaconteurJavaTest {
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if (command.equals("loopback"))
			{
				...
				/*testroot r=(testroot)RobotRaconteurNode.s().connectService("tcp://localhost:2323/{0}/RobotRaconteurTestService");
				...
				for (int i=0; i<count; i++)
				{
					...
					stest.RunFullTest("tcp://localhost:2323/{0}/RobotRaconteurTestService", "tcp://localhost:2323/{0}/RobotRaconteurTestService_auth");
				}
			...
			if (command.equals("serviceinfo2subscribertest"))
			{
				...
				ServiceInfo2Subscription sub=RobotRaconteurNode.s().subscribeServiceInfo2(new String[] {"com.robotraconteur.testing.TestService1.testroot"});
    ...
    protected static class async_ServiceInfo2 implements Action1<ServiceInfo2[]>
    {
		...
		@Override
		public void action(ServiceInfo2[] p1) {
    ...
    protected static class async_NodeInfo2 implements Action1<NodeInfo2[]>
    {
		...
		@Override
		public void action(NodeInfo2[] p1) {
			for (NodeInfo2 s : p1)
			{
			print_NodeInfo2(s);
			}
	...
	protected static class subscription_connect_listener implements Action3<ServiceSubscription, ServiceSubscriptionClientID, Object>
	{
		@Override
		public void action(ServiceSubscription subscription, ServiceSubscriptionClientID id, Object client)
		{
			System.out.println("Client connected: " + id.NodeID.toString() + "," + id.ServiceName);
		}
	}

	protected static class subscription_disconnect_listener implements Action3<ServiceSubscription, ServiceSubscriptionClientID, Object>
	{
		@Override
		public void action(ServiceSubscription subscription, ServiceSubscriptionClientID id, Object client)
		{
	...
	{
		@Override
		public void action(WireSubscription<double[]> sub, double[] val, TimeSpec time)
		{
	...
	{
		@Override
		public void action(PipeSubscription<double[]> sub)
		{
	...
	{
		@Override
		public Boolean func(ServiceInfo2 info)
		{
	...
	protected static class subscription_detected_listener implements Action3<ServiceInfo2Subscription, ServiceSubscriptionClientID, ServiceInfo2>
	{
		@Override
	...
	protected static class subscription_lost_listener implements Action3<ServiceInfo2Subscription, ServiceSubscriptionClientID, ServiceInfo2>
	{
		@Override
		public void action(ServiceInfo2Subscription subscription, ServiceSubscriptionClientID id, ServiceInfo2 client)
		{
