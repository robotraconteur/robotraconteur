	...
	protected final void testAsync_err(Exception exp)
	{
	 ...
	 public void asyncTestWirePeekPoke()
        ...
        public void test_m1()
        {
            ...
            if (r.get_pod_m1().length() != 1024) throw new RuntimeException("");
        ...
        public void test_namedarray_m1()
        {
            ...
            if (r.get_namedarray_m1().length() != 512) throw new RuntimeException();
        ...
        void testComplex()
        {
            ...
            if (!r.get_c1().equals( c1_1)) throw new RuntimeException();
            ...
            if (!r.get_c7().equals(c7_1)) throw new RuntimeException();
        ...
        {
            double[] c_m1_1 = new double[] { 8.952764e-05, 4.348213e-04, -1.051215e+08, 1.458626e-09, -2.575954e+10, 2.118740e+03, -2.555026e-02, 2.192576e-18, -2.035082e+18, 2.951834e-09, -1.760731e+15, 4.620903e-11, -3.098798e+05, -8.883556e-07, 2.472289e+17, 7.059075e-12 };
            ...
            double[] c_m2_2 = new double[] { -4.850043e-03, 3.545429e-07, 2.169430e+12, 1.175943e-09, 2.622300e+08, -4.439823e-11, -1.520489e+17, 8.250078e-14, 3.835439e-07, -1.424709e-02, 3.703099e+08, -1.971111e-08, -2.805354e+01, -2.093850e-17, -4.476148e+19, 9.914350e+11, 2.753067e+08, -1.745041e+14 };
