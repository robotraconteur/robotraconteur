...
public class Pipe<T>
{
	...
	public class PipeEndpoint
	{
		...
		private Vector<Action2<Pipe<T>.PipeEndpoint,Long>> packetacklisteners=new Vector<Action2<Pipe<T>.PipeEndpoint,Long>>();
		...
		private class directorclass extends WrappedPipeEndpointDirector
		{
			...
			public void packetAckReceivedEvent(long packetnum)
			{
				try
				{
					...
					{
					for(Enumeration<Action2<Pipe<T>.PipeEndpoint,Long>> e= pipe.packetacklisteners.elements(); e.hasMoreElements(); )
					{
			...
			public void packetReceivedEvent()
			{
				try
				{
					...
					{
					for(Enumeration<Action1<Pipe<T>.PipeEndpoint>> e= pipe.packetlisteners.elements(); e.hasMoreElements(); )
					{
