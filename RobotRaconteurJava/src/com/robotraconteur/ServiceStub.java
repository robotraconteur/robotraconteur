...
public abstract class ServiceStub
{
    ...
    public final Object findObjRef(String n)
    {
        ...
        synchronized (objref_lock)
        {
            ...
            {
                ServiceFactory f =
                    RobotRaconteurNode.s().getServiceType(s.getRR_objecttype().getServiceDefinition().getName());
    ...
    public static class AsyncRequestDirectorImpl extends AsyncRequestDirector
    {
        ...
        @Override public void handler(MessageElement m, HandlerErrorInfo error)
        {
    ...
    protected void rr_async_PropertyGet(String name, Action3<MessageElement, RuntimeException, Object> handler,
                                        Object param, int timeout)
    {
    ...
    protected void rr_async_PropertySet(String name, MessageElement value,
                                        Action3<MessageElement, RuntimeException, Object> handler, Object param,
                                        int timeout)
    {
        AsyncRequestDirectorImpl d = new AsyncRequestDirectorImpl(handler, param);
        int id = RRObjectHeap.addObject(d);
    ...
    protected void rr_async_FunctionCall(String name, vectorptr_messageelement p,
                                         Action3<MessageElement, RuntimeException, Object> handler, Object param,
                                         int timeout)
    {
        AsyncRequestDirectorImpl d = new AsyncRequestDirectorImpl(handler, param);
    ...
    protected void rr_async_GeneratorFunctionCall(String name, vectorptr_messageelement p,
                                                  Action3<WrappedGeneratorClient, RuntimeException, Object> handler,
                                                  Object param, int timeout)
    {
