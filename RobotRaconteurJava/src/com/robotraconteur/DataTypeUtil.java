...
public class DataTypeUtil
{
    ...
    public static DataTypes typeIDFromString(String stype)
    {
        ...
        if (stype.equals("class com.robotraconteur.UnsignedByte") ||
            stype.equals("class com.robotraconteur.UnsignedBytes"))
        ...
        if (stype.equals("class com.robotraconteur.UnsignedShort") ||
            stype.equals("class com.robotraconteur.UnsignedShorts"))
        ...
        if (stype.equals("class com.robotraconteur.UnsignedInteger") ||
            stype.equals("class com.robotraconteur.UnsignedIntegers"))
        ...
        if (stype.equals("class com.robotraconteur.UnsignedLong") ||
            stype.equals("class com.robotraconteur.UnsignedLongs"))
    ...
    public static boolean isArray(Object o)
    {
        ...
        if (o instanceof long[])
            return true;
        if (o instanceof UnsignedBytes)
            return true;
        if (o instanceof UnsignedShorts)
            return true;
        if (o instanceof UnsignedInts)
            return true;
        if (o instanceof UnsignedLongs)
            return true;
        if (o instanceof CDouble[])
            return true;
        if (o instanceof CSingle[])
            return true;
    ...
    public static boolean isScalarNumberType(Class o)
    {
        ...
        if (o == Long.class)
            return true;
        if (o == UnsignedByte.class)
            return true;
        if (o == UnsignedShort.class)
            return true;
        if (o == UnsignedInt.class)
            return true;
        if (o == UnsignedLong.class)
            return true;
        if (o == CDouble.class)
            return true;
        if (o == CSingle.class)
    ...
    {
        if (o instanceof double[])
            return new Double(((double[])o)[0]);
        if (o instanceof float[])
            return new Float(((float[])o)[0]);
        if (o instanceof byte[])
            return new Byte(((byte[])o)[0]);
        if (o instanceof short[])
            return new Short(((short[])o)[0]);
        if (o instanceof int[])
            return new Integer(((int[])o)[0]);
        if (o instanceof long[])
            return new Long(((long[])o)[0]);
        if (o instanceof UnsignedBytes)
            return ((UnsignedBytes)o).get(0);
        if (o instanceof UnsignedShorts)
            return ((UnsignedShorts)o).get(0);
        if (o instanceof UnsignedInts)
            return ((UnsignedInts)o).get(0);
        if (o instanceof UnsignedLongs)
            return ((UnsignedLongs)o).get(0);
        if (o instanceof CDouble[])
            return ((CDouble[])o)[0];
        if (o instanceof CSingle[])
            return ((CSingle[])o)[0];
    ...
    public static Object arrayFromScalar(Object o)
    {
        ...
        if (o instanceof UnsignedByte)
            return ((UnsignedByte)o).array();
        if (o instanceof UnsignedShort)
            return ((UnsignedShort)o).array();
        if (o instanceof UnsignedInt)
            return ((UnsignedInt)o).array();
        if (o instanceof UnsignedLong)
            return ((UnsignedLong)o).array();
        if (o instanceof CDouble)
            return new CDouble[] {(CDouble)o};
        if (o instanceof CSingle)
            return new CSingle[] {(CSingle)o};
        if (o instanceof Boolean)
    ...
    public static int getArrayLength(Object arr)
    {
        ...
        if (arr instanceof UnsignedBytes)
            return ((UnsignedBytes)arr).value.length;
        if (arr instanceof short[])
            return ((short[])arr).length;
        if (arr instanceof UnsignedShorts)
            return ((UnsignedShorts)arr).value.length;
        if (arr instanceof int[])
            return ((int[])arr).length;
        if (arr instanceof UnsignedInts)
            return ((UnsignedInts)arr).value.length;
        if (arr instanceof long[])
            return ((long[])arr).length;
        if (arr instanceof UnsignedLongs)
            return ((UnsignedLongs)arr).value.length;
        if (arr instanceof CDouble[])
            return ((CDouble[])arr).length;
        if (arr instanceof CSingle[])
            return ((CSingle[])arr).length;
    ...
    public static <K> Map<K, NamedMultiDimArray> verifyArrayLength4(Map<K, NamedMultiDimArray> a, int n_elems,
                                                                    int[] len)
    {
        if (a != null)
        {
