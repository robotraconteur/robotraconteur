...
#if defined(SWIGWORDSIZE64)
OUTPUT_TYPEMAP(long, jlong, long, Long, "[J", jlongArray);
OUTPUT_TYPEMAP(unsigned long, jobject, java.math.BigInteger, Object, "[Ljava/math/BigInteger;", jobjectArray);
#else
...
#if defined(SWIGWORDSIZE64)
INOUT_TYPEMAP(long, jlong, long, Long, "[J", jlongArray);
INOUT_TYPEMAP(unsigned long, jobject, java.math.BigInteger, Object, "[java/math/BigInteger;", jobjectArray);
#else
