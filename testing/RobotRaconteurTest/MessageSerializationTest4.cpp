...
static RR_INTRUSIVE_PTR<MessageElement> MessageSerializationTest4_NewRandomMessageElement(mt19937& rng, size_t depth)
{
    ...
    case DataTypes_structure_t: {
        ...
        e->SetData(CreateMessageElementNestedElementList(DataTypes_structure_t,
                                                         MessageSerializationTest4_NewRandomString(rng, 128), v));
        return e;
    }
    ...
    case DataTypes_pod_array_t: {
        ...
        e->SetData(CreateMessageElementNestedElementList(DataTypes_pod_array_t,
                                                         MessageSerializationTest4_NewRandomString(rng, 128), v));
        return e;
    }
    case DataTypes_pod_multidimarray_t: {
        ...
        e->SetData(CreateMessageElementNestedElementList(DataTypes_pod_multidimarray_t,
                                                         MessageSerializationTest4_NewRandomString(rng, 128), v));
        return e;
    }
    case DataTypes_namedarray_array_t: {
        ...
        e->SetData(CreateMessageElementNestedElementList(DataTypes_namedarray_array_t,
                                                         MessageSerializationTest4_NewRandomString(rng, 128), v));
        return e;
    }
    case DataTypes_namedarray_multidimarray_t: {
        ...
        e->SetData(CreateMessageElementNestedElementList(DataTypes_namedarray_multidimarray_t,
                                                         MessageSerializationTest4_NewRandomString(rng, 128), v));
        return e;
    }
    default:
...
RR_INTRUSIVE_PTR<Message> MessageSerializationTest4::NewRandomTestMessage4(boost::random::mt19937& rng)
{
    ...
    if (h->MessageFlags & MessageFlags_STRING_TABLE)
    {
        ...
        for (size_t i = 0; i < n; i++)
        {
            h->StringTable.push_back(
                boost::make_tuple(uint32_dist(rng), MessageSerializationTest4_NewRandomString(rng, 128)));
        }
    }
...
void MessageSerializationTest4::Test2(bool use_string_table)
{
    ...
    RR_SHARED_PTR<RobotRaconteur::detail::StringTable> string_table1 =
        RR_MAKE_SHARED<RobotRaconteur::detail::StringTable>(false);
    if (use_string_table)
    {
    ...
    if (use_string_table)
    {
        RR_SHARED_PTR<RobotRaconteur::detail::StringTable> string_table2 =
            RR_MAKE_SHARED<RobotRaconteur::detail::StringTable>(false);
