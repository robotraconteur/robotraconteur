...
void RobotRaconteurTestService2Support::RegisterServices(RR_SHARED_PTR<TcpTransport> transport)
{
    ...
    RR_SHARED_PTR<ServerContext> c = RobotRaconteurNode::s()->RegisterService(
        "RobotRaconteurTestService2", "com.robotraconteur.testing.TestService3", testservice2);
...
void testroot3_impl::set_peekwire(RR_SHARED_PTR<Wire<int32_t> > value)
{
    ...
    peekwire_timer = RobotRaconteurNode::s()->CreateTimer(
...
void testroot3_impl::set_b3(RR_INTRUSIVE_PTR<RRMultiDimArray<rr_bool> > value)
{
    ...
    if (value->Array->size() != 2)
        throw std::runtime_error("");
    if (value->Dims->at(0) != 2)
        throw std::runtime_error("");
    if (value->Dims->at(1) != 1)
        throw std::runtime_error("");
    if (value->Array->at(0) == 0)
        throw std::runtime_error("");
    if (value->Array->at(1) != 0)
        throw std::runtime_error("");
}
...
void testroot3_impl::set_b4(RR_INTRUSIVE_PTR<RRList<RRArray<rr_bool> > > value)
{
    ...
    if (value->size() != 1)
        throw std::runtime_error("");
    if (value->front()->size() != 1)
        throw std::runtime_error("");
    if (value->front()->at(0) == 0)
        throw std::runtime_error("");
}
...
void testroot3_impl::set_b5(RR_INTRUSIVE_PTR<RRList<RRArray<rr_bool> > > value)
{
    ...
    if (!value->front())
        throw std::runtime_error("");
    if (value->front()->size() != 2)
        throw std::runtime_error("");
    if (value->front()->at(0) == 0)
        throw std::runtime_error("");
    if (value->front()->at(1) != 0)
        throw std::runtime_error("");
}
...
void testroot3_impl::set_b6(RR_INTRUSIVE_PTR<RRList<RRMultiDimArray<rr_bool> > > value)
{
    ...
    if (value1->Dims->size() != 2)
        throw std::runtime_error("");
    if (value1->Array->size() != 2)
        throw std::runtime_error("");
    if (value1->Dims->at(0) != 2)
        throw std::runtime_error("");
    if (value1->Dims->at(1) != 1)
        throw std::runtime_error("");
    if (value1->Array->at(0) == 0)
        throw std::runtime_error("");
    if (value1->Array->at(1) != 0)
        throw std::runtime_error("");
}
...
void ServiceTest2_verify_testpod1(const com::robotraconteur::testing::TestService3::testpod1& v, uint32_t seed)
{
    ...
    if (v.d1 != gen.get_double())
        throw std::runtime_error("");
    for (size_t i = 0; i < v.d2.size(); i++)
        if (v.d2[i] != gen.get_double())
            throw std::runtime_error("");
    size_t d3_len = gen.get_uint32() % 6;
    if (v.d3.size() != d3_len)
        throw std::runtime_error("");
    for (size_t i = 0; i < d3_len; i++)
        if (v.d3[i] != gen.get_double())
            throw std::runtime_error("");
    for (size_t i = 0; i < v.d4.size(); i++)
        if (v.d4[i] != gen.get_double())
            throw std::runtime_error("");
...
void ServiceTest2_verify_testpod2(const com::robotraconteur::testing::TestService3::testpod2& v, uint32_t seed)
{
    ...
    if (v.i1 != gen.get_int8())
        throw std::runtime_error("");
    for (size_t i = 0; i < v.i2.size(); i++)
        if (v.i2[i] != gen.get_int8())
            throw std::runtime_error("");
