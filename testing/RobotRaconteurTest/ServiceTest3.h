                           ...
                           public RR_ENABLE_SHARED_FROM_THIS<asynctestroot_impl>
{
  public:
    ...
    virtual RR_SHARED_PTR<RobotRaconteur::Generator<double, void> > err_func3() RR_OVERRIDE;
};
} // namespace RobotRaconteurTest
