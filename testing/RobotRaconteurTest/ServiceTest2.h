...
namespace RobotRaconteurTest
{
	...
	public:
		...
		virtual RR_SHARED_PTR<RobotRaconteur::RRNamedArray<com::robotraconteur::testing::TestService3::transform> > get_testnamedarray3();
		virtual void set_testnamedarray3(RR_SHARED_PTR<RobotRaconteur::RRNamedArray<com::robotraconteur::testing::TestService3::transform> > value);

		virtual RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > get_testnamedarray4();
		virtual void set_testnamedarray4(RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > value);

		virtual RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > get_testnamedarray5();
		virtual void set_testnamedarray5(RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > value);
	...
	protected:
		...
		RR_SHARED_PTR<RobotRaconteur::RRNamedArray<com::robotraconteur::testing::TestService3::transform> > testnamedarray3;
		RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > testnamedarray4;
		RR_SHARED_PTR<RobotRaconteur::RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > testnamedarray5;
	...
	void ServiceTest2_verify_testpod1_array(RR_SHARED_PTR<RRPodArray<com::robotraconteur::testing::TestService3::testpod1> > v, size_t s, uint32_t seed);

	RR_SHARED_PTR<RRPodMultiDimArray<com::robotraconteur::testing::TestService3::testpod1> > ServiceTest2_fill_testpod1_multidimarray(size_t m, size_t n, uint32_t seed);
	...
	RR_SHARED_PTR<RRNamedArray<com::robotraconteur::testing::TestService3::transform> > ServiceTest2_fill_transform_array(size_t s, uint32_t seed);
	void ServiceTest2_verify_transform_array(RR_SHARED_PTR<RRNamedArray<com::robotraconteur::testing::TestService3::transform> > v, size_t s, uint32_t seed);
	RR_SHARED_PTR<RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > ServiceTest2_fill_transform_multidimarray(size_t m, size_t n, uint32_t seed);
	void ServiceTest2_verify_transform_multidimarray(RR_SHARED_PTR<RRNamedMultiDimArray<com::robotraconteur::testing::TestService3::transform> > v, size_t m, size_t n, uint32_t seed);
