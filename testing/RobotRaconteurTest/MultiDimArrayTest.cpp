...
namespace RobotRaconteurTest
{
	...
	void MultiDimArrayTest::TestDouble()
	{
		...
		m1->AssignSubArray(vector<uint32_t>(m1a,m1a+5),m2,vector<uint32_t>(m1b,m1b+5),vector<uint32_t>(m1c,m1c+5));
		...
		m1->RetrieveSubArray(vector<uint32_t>(m4a,m4a+5),m6,vector<uint32_t>(m4b,m4b+5),vector<uint32_t>(m4c,m4c+5));
		...
		m1->RetrieveSubArray(vector<uint32_t>(m5a,m5a+5),m7,vector<uint32_t>(m5b,m5b+5),vector<uint32_t>(m5c,m5c+5));
	...
	void MultiDimArrayTest::TestByte()
	{
		...
		m1->AssignSubArray(vector<uint32_t>(m1a,m1a+2),m2,vector<uint32_t>(m1b,m1b+2),vector<uint32_t>(m1c,m1c+2));
		ca(m1->Array,m3->Array);
		...
		m1->RetrieveSubArray(vector<uint32_t>(m4a,m4a+2),m6,vector<uint32_t>(m4b,m4b+2),vector<uint32_t>(m4c,m4c+2));
		ca(m4->Array,m6->Array);
		...
		m1->RetrieveSubArray(vector<uint32_t>(m5a,m5a+2),m7,vector<uint32_t>(m5b,m5b+2),vector<uint32_t>(m5c,m5c+2));
		ca(m5->Array,m7->Array);
