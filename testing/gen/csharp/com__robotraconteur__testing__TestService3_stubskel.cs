...
public interface async_testroot3
{
    ...
    void async_get_t1(Action<RRDateTime,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t1(RRDateTime value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t2(Action<RRDateTime[],Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t2(RRDateTime[] value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t3(Action<MultiDimArray,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t3(MultiDimArray value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t4(Action<List<RRDateTime>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t4(List<RRDateTime> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t5(Action<List<RRDateTime[]>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t5(List<RRDateTime[]> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t6(Action<List<MultiDimArray>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t6(List<MultiDimArray> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t7(Action<RRDuration,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t7(RRDuration value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t8(Action<RRDuration[],Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t8(RRDuration[] value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t9(Action<MultiDimArray,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t9(MultiDimArray value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t10(Action<List<RRDuration>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t10(List<RRDuration> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t11(Action<List<RRDuration[]>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t11(List<RRDuration[]> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_get_t12(Action<List<MultiDimArray>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
    void async_set_t12(List<MultiDimArray> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE);
...
public class testroot3_stub : ServiceStub , testroot3, async_testroot3{
    ...
    private ArrayMemory<RRDateTime> rr_c_m7;
    private MultiDimArrayMemory<RRDateTime> rr_c_m8;
    private ArrayMemory<RRDuration> rr_c_m9;
    private MultiDimArrayMemory<RRDuration> rr_c_m10;
    ...
    rr_c_m7=new ArrayMemoryClient<RRDateTime>(innerstub.GetArrayMemory("c_m7"));
    rr_c_m8=new MultiDimArrayMemoryClient<RRDateTime>(innerstub.GetMultiDimArrayMemory("c_m8"));
    rr_c_m9=new ArrayMemoryClient<RRDuration>(innerstub.GetArrayMemory("c_m9"));
    rr_c_m10=new MultiDimArrayMemoryClient<RRDuration>(innerstub.GetMultiDimArrayMemory("c_m10"));
    }
    public int readme {
    get {
    ...
    public RRDateTime t1 {
    get {
    return (MessageElementUtil.UnpackScalar<RRDateTime>(rr_innerstub.PropertyGet("t1")));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackScalar<RRDateTime>("value",value))
    {
    rr_innerstub.PropertySet("t1", m);
    }
    }
    }
    public RRDateTime[] t2 {
    get {
    return MessageElementUtil.UnpackArray<RRDateTime>(rr_innerstub.PropertyGet("t2"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackArray<RRDateTime>("value",value))
    {
    rr_innerstub.PropertySet("t2", m);
    }
    }
    }
    public MultiDimArray t3 {
    get {
    return MessageElementUtil.UnpackMultiDimArray(rr_innerstub.PropertyGet("t3"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackMultiDimArray("value",(MultiDimArray)value))
    {
    rr_innerstub.PropertySet("t3", m);
    }
    }
    }
    public List<RRDateTime> t4 {
    get {
    return MessageElementUtil.UnpackList<RRDateTime>(rr_innerstub.PropertyGet("t4"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<RRDateTime>("value",value))
    {
    rr_innerstub.PropertySet("t4", m);
    }
    }
    }
    public List<RRDateTime[]> t5 {
    get {
    return MessageElementUtil.UnpackList<RRDateTime[]>(rr_innerstub.PropertyGet("t5"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<RRDateTime[]>("value",value))
    {
    rr_innerstub.PropertySet("t5", m);
    }
    }
    }
    public List<MultiDimArray> t6 {
    get {
    return MessageElementUtil.UnpackList<MultiDimArray>(rr_innerstub.PropertyGet("t6"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<MultiDimArray>("value",value))
    {
    rr_innerstub.PropertySet("t6", m);
    }
    }
    }
    public RRDuration t7 {
    get {
    return (MessageElementUtil.UnpackScalar<RRDuration>(rr_innerstub.PropertyGet("t7")));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackScalar<RRDuration>("value",value))
    {
    rr_innerstub.PropertySet("t7", m);
    }
    }
    }
    public RRDuration[] t8 {
    get {
    return MessageElementUtil.UnpackArray<RRDuration>(rr_innerstub.PropertyGet("t8"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackArray<RRDuration>("value",value))
    {
    rr_innerstub.PropertySet("t8", m);
    }
    }
    }
    public MultiDimArray t9 {
    get {
    return MessageElementUtil.UnpackMultiDimArray(rr_innerstub.PropertyGet("t9"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackMultiDimArray("value",(MultiDimArray)value))
    {
    rr_innerstub.PropertySet("t9", m);
    }
    }
    }
    public List<RRDuration> t10 {
    get {
    return MessageElementUtil.UnpackList<RRDuration>(rr_innerstub.PropertyGet("t10"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<RRDuration>("value",value))
    {
    rr_innerstub.PropertySet("t10", m);
    }
    }
    }
    public List<RRDuration[]> t11 {
    get {
    return MessageElementUtil.UnpackList<RRDuration[]>(rr_innerstub.PropertyGet("t11"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<RRDuration[]>("value",value))
    {
    rr_innerstub.PropertySet("t11", m);
    }
    }
    }
    public List<MultiDimArray> t12 {
    get {
    return MessageElementUtil.UnpackList<MultiDimArray>(rr_innerstub.PropertyGet("t12"));
    }
    set {
    using(MessageElement m=MessageElementUtil.PackListType<MultiDimArray>("value",value))
    {
    rr_innerstub.PropertySet("t12", m);
    }
    }
    }
    ...
    public ArrayMemory<RRDateTime> c_m7 { 
    get { return rr_c_m7; }
    }
    public MultiDimArrayMemory<RRDateTime> c_m8 {
    get { return rr_c_m8; }
    }
    public ArrayMemory<RRDuration> c_m9 { 
    get { return rr_c_m9; }
    }
    public MultiDimArrayMemory<RRDuration> c_m10 {
    get { return rr_c_m10; }
    }
    ...
    public virtual void async_get_t1(Action<RRDateTime,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t1",rrend_async_get_t1,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t1(MessageElement value ,Exception err,object param)
    {
    Action<RRDateTime,Exception> rr_handler=(Action<RRDateTime,Exception>)param;
    if (err!=null)
    {
    rr_handler(default(RRDateTime),err);
    return;
    }
    RRDateTime rr_ret;
    try {
    rr_ret=(MessageElementUtil.UnpackScalar<RRDateTime>(value));
    } catch (Exception err2) {
    rr_handler(default(RRDateTime),err2);
    return;
    }
    rr_handler(rr_ret,null);
    }
    public virtual void async_set_t1(RRDateTime value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackScalar<RRDateTime>("value",value))
    {
    rr_async_PropertySet("t1",mm,rrend_async_set_t1,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t1(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t2(Action<RRDateTime[],Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t2",rrend_async_get_t2,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t2(MessageElement value ,Exception err,object param)
    {
    Action<RRDateTime[],Exception> rr_handler=(Action<RRDateTime[],Exception>)param;
    if (err!=null)
    {
    ...
    RRDateTime[] rr_ret;
    try {
    rr_ret=MessageElementUtil.UnpackArray<RRDateTime>(value);
    } catch (Exception err2) {
    rr_handler(default(RRDateTime[]),err2);
    return;
    }
    ...
    public virtual void async_set_t2(RRDateTime[] value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackArray<RRDateTime>("value",value))
    {
    rr_async_PropertySet("t2",mm,rrend_async_set_t2,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t2(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t3(Action<MultiDimArray,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t3",rrend_async_get_t3,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t3(MessageElement value ,Exception err,object param)
    {
    Action<MultiDimArray,Exception> rr_handler=(Action<MultiDimArray,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t3(MultiDimArray value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackMultiDimArray("value",(MultiDimArray)value))
    {
    rr_async_PropertySet("t3",mm,rrend_async_set_t3,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t3(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t4(Action<List<RRDateTime>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t4",rrend_async_get_t4,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t4(MessageElement value ,Exception err,object param)
    {
    Action<List<RRDateTime>,Exception> rr_handler=(Action<List<RRDateTime>,Exception>)param;
    if (err!=null)
    {
    rr_handler(default(List<RRDateTime>),err);
    return;
    }
    List<RRDateTime> rr_ret;
    try {
    rr_ret=MessageElementUtil.UnpackList<RRDateTime>(value);
    } catch (Exception err2) {
    rr_handler(default(List<RRDateTime>),err2);
    return;
    }
    rr_handler(rr_ret,null);
    }
    public virtual void async_set_t4(List<RRDateTime> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<RRDateTime>("value",value))
    {
    rr_async_PropertySet("t4",mm,rrend_async_set_t4,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t4(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t5(Action<List<RRDateTime[]>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t5",rrend_async_get_t5,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t5(MessageElement value ,Exception err,object param)
    {
    Action<List<RRDateTime[]>,Exception> rr_handler=(Action<List<RRDateTime[]>,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t5(List<RRDateTime[]> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<RRDateTime[]>("value",value))
    {
    rr_async_PropertySet("t5",mm,rrend_async_set_t5,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t5(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t6(Action<List<MultiDimArray>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t6",rrend_async_get_t6,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t6(MessageElement value ,Exception err,object param)
    {
    Action<List<MultiDimArray>,Exception> rr_handler=(Action<List<MultiDimArray>,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t6(List<MultiDimArray> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<MultiDimArray>("value",value))
    {
    rr_async_PropertySet("t6",mm,rrend_async_set_t6,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t6(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t7(Action<RRDuration,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t7",rrend_async_get_t7,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t7(MessageElement value ,Exception err,object param)
    {
    Action<RRDuration,Exception> rr_handler=(Action<RRDuration,Exception>)param;
    if (err!=null)
    {
    rr_handler(default(RRDuration),err);
    return;
    }
    RRDuration rr_ret;
    try {
    rr_ret=(MessageElementUtil.UnpackScalar<RRDuration>(value));
    } catch (Exception err2) {
    rr_handler(default(RRDuration),err2);
    return;
    }
    rr_handler(rr_ret,null);
    }
    public virtual void async_set_t7(RRDuration value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackScalar<RRDuration>("value",value))
    {
    rr_async_PropertySet("t7",mm,rrend_async_set_t7,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t7(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t8(Action<RRDuration[],Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t8",rrend_async_get_t8,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t8(MessageElement value ,Exception err,object param)
    {
    Action<RRDuration[],Exception> rr_handler=(Action<RRDuration[],Exception>)param;
    if (err!=null)
    {
    ...
    RRDuration[] rr_ret;
    try {
    rr_ret=MessageElementUtil.UnpackArray<RRDuration>(value);
    } catch (Exception err2) {
    rr_handler(default(RRDuration[]),err2);
    return;
    }
    ...
    public virtual void async_set_t8(RRDuration[] value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackArray<RRDuration>("value",value))
    {
    rr_async_PropertySet("t8",mm,rrend_async_set_t8,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t8(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t9(Action<MultiDimArray,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t9",rrend_async_get_t9,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t9(MessageElement value ,Exception err,object param)
    {
    Action<MultiDimArray,Exception> rr_handler=(Action<MultiDimArray,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t9(MultiDimArray value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackMultiDimArray("value",(MultiDimArray)value))
    {
    rr_async_PropertySet("t9",mm,rrend_async_set_t9,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t9(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t10(Action<List<RRDuration>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t10",rrend_async_get_t10,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t10(MessageElement value ,Exception err,object param)
    {
    Action<List<RRDuration>,Exception> rr_handler=(Action<List<RRDuration>,Exception>)param;
    if (err!=null)
    {
    rr_handler(default(List<RRDuration>),err);
    return;
    }
    List<RRDuration> rr_ret;
    try {
    rr_ret=MessageElementUtil.UnpackList<RRDuration>(value);
    } catch (Exception err2) {
    rr_handler(default(List<RRDuration>),err2);
    return;
    }
    rr_handler(rr_ret,null);
    }
    public virtual void async_set_t10(List<RRDuration> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<RRDuration>("value",value))
    {
    rr_async_PropertySet("t10",mm,rrend_async_set_t10,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t10(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t11(Action<List<RRDuration[]>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t11",rrend_async_get_t11,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t11(MessageElement value ,Exception err,object param)
    {
    Action<List<RRDuration[]>,Exception> rr_handler=(Action<List<RRDuration[]>,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t11(List<RRDuration[]> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<RRDuration[]>("value",value))
    {
    rr_async_PropertySet("t11",mm,rrend_async_set_t11,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t11(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_get_t12(Action<List<MultiDimArray>,Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    rr_async_PropertyGet("t12",rrend_async_get_t12,rr_handler,rr_timeout);
    }
    protected virtual void rrend_async_get_t12(MessageElement value ,Exception err,object param)
    {
    Action<List<MultiDimArray>,Exception> rr_handler=(Action<List<MultiDimArray>,Exception>)param;
    if (err!=null)
    {
    ...
    public virtual void async_set_t12(List<MultiDimArray> value, Action<Exception> rr_handler, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    using(MessageElement mm=MessageElementUtil.PackListType<MultiDimArray>("value",value))
    {
    rr_async_PropertySet("t12",mm,rrend_async_set_t12,rr_handler,rr_timeout);
    }
    }
    protected virtual void rrend_async_set_t12(MessageElement m ,Exception err,object param)
    {
    Action<Exception> rr_handler=(Action<Exception>)param;
    if (err!=null)
    {
...
public class testroot3_skel : ServiceSkel {
    ...
    case "t1":
    {
    RRDateTime ret=obj.t1;
    return MessageElementUtil.PackScalar<RRDateTime>("return",ret);
    }
    case "t2":
    {
    RRDateTime[] ret=obj.t2;
    return MessageElementUtil.PackArray<RRDateTime>("return",ret);
    }
    case "t3":
    {
    MultiDimArray ret=obj.t3;
    return MessageElementUtil.PackMultiDimArray("return",(MultiDimArray)ret);
    }
    case "t4":
    {
    List<RRDateTime> ret=obj.t4;
    return MessageElementUtil.PackListType<RRDateTime>("return",ret);
    }
    case "t5":
    {
    List<RRDateTime[]> ret=obj.t5;
    return MessageElementUtil.PackListType<RRDateTime[]>("return",ret);
    }
    case "t6":
    {
    List<MultiDimArray> ret=obj.t6;
    return MessageElementUtil.PackListType<MultiDimArray>("return",ret);
    }
    case "t7":
    {
    RRDuration ret=obj.t7;
    return MessageElementUtil.PackScalar<RRDuration>("return",ret);
    }
    case "t8":
    {
    RRDuration[] ret=obj.t8;
    return MessageElementUtil.PackArray<RRDuration>("return",ret);
    }
    case "t9":
    {
    MultiDimArray ret=obj.t9;
    return MessageElementUtil.PackMultiDimArray("return",(MultiDimArray)ret);
    }
    case "t10":
    {
    List<RRDuration> ret=obj.t10;
    return MessageElementUtil.PackListType<RRDuration>("return",ret);
    }
    case "t11":
    {
    List<RRDuration[]> ret=obj.t11;
    return MessageElementUtil.PackListType<RRDuration[]>("return",ret);
    }
    case "t12":
    {
    List<MultiDimArray> ret=obj.t12;
    return MessageElementUtil.PackListType<MultiDimArray>("return",ret);
    }
    default:
    break;
    ...
    case "t1":
    {
    obj.t1=(MessageElementUtil.UnpackScalar<RRDateTime>(m));
    return;
    }
    case "t2":
    {
    obj.t2=MessageElementUtil.UnpackArray<RRDateTime>(m);
    return;
    }
    case "t3":
    {
    obj.t3=MessageElementUtil.UnpackMultiDimArray(m);
    return;
    }
    case "t4":
    {
    obj.t4=MessageElementUtil.UnpackList<RRDateTime>(m);
    return;
    }
    case "t5":
    {
    obj.t5=MessageElementUtil.UnpackList<RRDateTime[]>(m);
    return;
    }
    case "t6":
    {
    obj.t6=MessageElementUtil.UnpackList<MultiDimArray>(m);
    return;
    }
    case "t7":
    {
    obj.t7=(MessageElementUtil.UnpackScalar<RRDuration>(m));
    return;
    }
    case "t8":
    {
    obj.t8=MessageElementUtil.UnpackArray<RRDuration>(m);
    return;
    }
    case "t9":
    {
    obj.t9=MessageElementUtil.UnpackMultiDimArray(m);
    return;
    }
    case "t10":
    {
    obj.t10=MessageElementUtil.UnpackList<RRDuration>(m);
    return;
    }
    case "t11":
    {
    obj.t11=MessageElementUtil.UnpackList<RRDuration[]>(m);
    return;
    }
    case "t12":
    {
    obj.t12=MessageElementUtil.UnpackList<MultiDimArray>(m);
    return;
    }
    default:
    break;
    ...
    case "c_m7": {
    WrappedArrayMemoryDirectorNET<RRDateTime> dir=new  WrappedArrayMemoryDirectorNET<RRDateTime>(obj.c_m7);
    return dir;
    }
    case "c_m9": {
    WrappedArrayMemoryDirectorNET<RRDuration> dir=new  WrappedArrayMemoryDirectorNET<RRDuration>(obj.c_m9);
    return dir;
    }
    default:
    break;
    ...
    case "c_m8": {
    WrappedMultiDimArrayMemoryDirectorNET<RRDateTime> dir=new  WrappedMultiDimArrayMemoryDirectorNET<RRDateTime>(obj.c_m8);
    return dir;
    }
    case "c_m10": {
    WrappedMultiDimArrayMemoryDirectorNET<RRDuration> dir=new  WrappedMultiDimArrayMemoryDirectorNET<RRDuration>(obj.c_m10);
    return dir;
    }
    default:
    break;
...
public class testroot3_default_impl : testroot3{
    ...
    public virtual RRDateTime t1 {get; set;} = default(RRDateTime);
    public virtual RRDateTime[] t2 {get; set;} = new RRDateTime[0];
    public virtual MultiDimArray t3 {get; set;} = new MultiDimArray(new uint[] {1,0}, new RRDateTime[0]);
    public virtual List<RRDateTime> t4 {get; set;} = default(List<RRDateTime>);
    public virtual List<RRDateTime[]> t5 {get; set;} = default(List<RRDateTime[]>);
    public virtual List<MultiDimArray> t6 {get; set;} = default(List<MultiDimArray>);
    public virtual RRDuration t7 {get; set;} = default(RRDuration);
    public virtual RRDuration[] t8 {get; set;} = new RRDuration[0];
    public virtual MultiDimArray t9 {get; set;} = new MultiDimArray(new uint[] {1,0}, new RRDuration[0]);
    public virtual List<RRDuration> t10 {get; set;} = default(List<RRDuration>);
    public virtual List<RRDuration[]> t11 {get; set;} = default(List<RRDuration[]>);
    public virtual List<MultiDimArray> t12 {get; set;} = default(List<MultiDimArray>);
    ...
    public virtual ArrayMemory<RRDateTime> c_m7 { 
    get { throw new NotImplementedException(); }
    }
    public virtual MultiDimArrayMemory<RRDateTime> c_m8 {
    get { throw new NotImplementedException(); }
    }
    public virtual ArrayMemory<RRDuration> c_m9 { 
    get { throw new NotImplementedException(); }
    }
    public virtual MultiDimArrayMemory<RRDuration> c_m10 {
    get { throw new NotImplementedException(); }
    }
}
...
public static class RRExtensions{
    ...
    public static Task<RRDateTime> async_get_t1(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<RRDateTime> t=new RobotRaconteurTaskCompletion<RRDateTime>();
    rr_obj.async_get_t1(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t1(this async_testroot3 rr_obj, RRDateTime value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t1(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<RRDateTime[]> async_get_t2(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<RRDateTime[]> t=new RobotRaconteurTaskCompletion<RRDateTime[]>();
    rr_obj.async_get_t2(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t2(this async_testroot3 rr_obj, RRDateTime[] value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t2(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<MultiDimArray> async_get_t3(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<MultiDimArray> t=new RobotRaconteurTaskCompletion<MultiDimArray>();
    rr_obj.async_get_t3(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t3(this async_testroot3 rr_obj, MultiDimArray value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t3(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<RRDateTime>> async_get_t4(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<RRDateTime>> t=new RobotRaconteurTaskCompletion<List<RRDateTime>>();
    rr_obj.async_get_t4(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t4(this async_testroot3 rr_obj, List<RRDateTime> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t4(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<RRDateTime[]>> async_get_t5(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<RRDateTime[]>> t=new RobotRaconteurTaskCompletion<List<RRDateTime[]>>();
    rr_obj.async_get_t5(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t5(this async_testroot3 rr_obj, List<RRDateTime[]> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t5(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<MultiDimArray>> async_get_t6(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<MultiDimArray>> t=new RobotRaconteurTaskCompletion<List<MultiDimArray>>();
    rr_obj.async_get_t6(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t6(this async_testroot3 rr_obj, List<MultiDimArray> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t6(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<RRDuration> async_get_t7(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<RRDuration> t=new RobotRaconteurTaskCompletion<RRDuration>();
    rr_obj.async_get_t7(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t7(this async_testroot3 rr_obj, RRDuration value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t7(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<RRDuration[]> async_get_t8(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<RRDuration[]> t=new RobotRaconteurTaskCompletion<RRDuration[]>();
    rr_obj.async_get_t8(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t8(this async_testroot3 rr_obj, RRDuration[] value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t8(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<MultiDimArray> async_get_t9(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<MultiDimArray> t=new RobotRaconteurTaskCompletion<MultiDimArray>();
    rr_obj.async_get_t9(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t9(this async_testroot3 rr_obj, MultiDimArray value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t9(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<RRDuration>> async_get_t10(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<RRDuration>> t=new RobotRaconteurTaskCompletion<List<RRDuration>>();
    rr_obj.async_get_t10(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t10(this async_testroot3 rr_obj, List<RRDuration> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t10(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<RRDuration[]>> async_get_t11(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<RRDuration[]>> t=new RobotRaconteurTaskCompletion<List<RRDuration[]>>();
    rr_obj.async_get_t11(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t11(this async_testroot3 rr_obj, List<RRDuration[]> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t11(value,t.handler,rr_timeout);
    return t.Task;
    }
    public static Task<List<MultiDimArray>> async_get_t12(this async_testroot3 rr_obj, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurTaskCompletion<List<MultiDimArray>> t=new RobotRaconteurTaskCompletion<List<MultiDimArray>>();
    rr_obj.async_get_t12(t.handler,rr_timeout);
    return t.Task;
    }
    public static Task async_set_t12(this async_testroot3 rr_obj, List<MultiDimArray> value, int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
    {
    RobotRaconteurVoidTaskCompletion t=new RobotRaconteurVoidTaskCompletion();
    rr_obj.async_set_t12(value,t.handler,rr_timeout);
    return t.Task;
    }
