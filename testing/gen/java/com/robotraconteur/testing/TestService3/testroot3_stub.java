...
public class testroot3_stub extends ServiceStub implements testroot3, async_testroot3 {
    ...
    private ArrayMemory<DateTime[]> rr_c_m7;
    private MultiDimArrayMemory<DateTime[]> rr_c_m8;
    private ArrayMemory<Duration[]> rr_c_m9;
    private MultiDimArrayMemory<Duration[]> rr_c_m10;
    ...
    rr_c_m7=new ArrayMemoryClient<DateTime[]>(innerstub.getArrayMemory("c_m7"));
    rr_c_m8=new MultiDimArrayMemoryClient<DateTime[]>(innerstub.getMultiDimArrayMemory("c_m8"));
    rr_c_m9=new ArrayMemoryClient<Duration[]>(innerstub.getArrayMemory("c_m9"));
    rr_c_m10=new MultiDimArrayMemoryClient<Duration[]>(innerstub.getMultiDimArrayMemory("c_m10"));
    }
    ...
    return (MessageElementUtil.<DateTime[]>castDataAndDispose(rr_innerstub.propertyGet("t1")))[0];
    }
    public void set_t1(DateTime value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packArray("value",new DateTime[] {value});
    ...
    return MessageElementUtil.<DateTime[]>unpackArray(rr_innerstub.propertyGet("t2"));
    }
    public void set_t2(DateTime[] value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packArray("value",value);
    ...
    return MessageElementUtil.<DateTime[]>unpackListType(rr_innerstub.propertyGet("t4"));
    }
    public void set_t4(List<DateTime[]> value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packListType("value",value,DateTime[].class);
    ...
    return MessageElementUtil.<DateTime[]>unpackListType(rr_innerstub.propertyGet("t5"));
    }
    ...
    return MessageElementUtil.<MultiDimArray>unpackListType(rr_innerstub.propertyGet("t6"));
    }
    ...
    return (MessageElementUtil.<Duration[]>castDataAndDispose(rr_innerstub.propertyGet("t7")))[0];
    }
    public void set_t7(Duration value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packArray("value",new Duration[] {value});
    ...
    return MessageElementUtil.<Duration[]>unpackArray(rr_innerstub.propertyGet("t8"));
    }
    public void set_t8(Duration[] value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packArray("value",value);
    ...
    return MessageElementUtil.<Duration[]>unpackListType(rr_innerstub.propertyGet("t10"));
    }
    public void set_t10(List<Duration[]> value) {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packListType("value",value,Duration[].class);
    ...
    return MessageElementUtil.<Duration[]>unpackListType(rr_innerstub.propertyGet("t11"));
    }
    ...
    return MessageElementUtil.<MultiDimArray>unpackListType(rr_innerstub.propertyGet("t12"));
    }
    ...
    public void async_get_t1(Action2<DateTime,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t1",new rrend_async_get_t1(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t1 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<DateTime,RuntimeException> rr_handler=(Action2<DateTime,RuntimeException>)param;
    if (err!=null)
    {
    rr_handler.action(new DateTime(0,0),err);
    return;
    }
    DateTime rr_ret;
    try {
    rr_ret=(MessageElementUtil.<DateTime[]>castDataAndDispose(value))[0];
    } catch (RuntimeException err2) {
    rr_handler.action(new DateTime(0,0),err2);
    return;
    }
    rr_handler.action(rr_ret,null);
    }
    }
    public void async_set_t1(DateTime value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packArray("value",new DateTime[] {value});
    rr_async_PropertySet("t1",m,new rrend_async_set_t1(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t1 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t2(Action2<DateTime[],RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t2",new rrend_async_get_t2(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t2 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<DateTime[],RuntimeException> rr_handler=(Action2<DateTime[],RuntimeException>)param;
    if (err!=null)
    ...
    DateTime[] rr_ret;
    try {
    rr_ret=MessageElementUtil.<DateTime[]>unpackArray(value);
    } catch (RuntimeException err2) {
    rr_handler.action(null,err2);
    return;
    }
    ...
    public void async_set_t2(DateTime[] value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packArray("value",value);
    rr_async_PropertySet("t2",m,new rrend_async_set_t2(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t2 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t3(Action2<MultiDimArray,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t3",new rrend_async_get_t3(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t3 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<MultiDimArray,RuntimeException> rr_handler=(Action2<MultiDimArray,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t3(MultiDimArray value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.packMultiDimArray("value",(MultiDimArray)value);
    rr_async_PropertySet("t3",m,new rrend_async_set_t3(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t3 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t4(Action2<List<DateTime[]>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t4",new rrend_async_get_t4(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t4 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<DateTime[]>,RuntimeException> rr_handler=(Action2<List<DateTime[]>,RuntimeException>)param;
    if (err!=null)
    {
    rr_handler.action(null,err);
    return;
    }
    List<DateTime[]> rr_ret;
    try {
    rr_ret=MessageElementUtil.<DateTime[]>unpackListType(value);
    } catch (RuntimeException err2) {
    rr_handler.action(null,err2);
    return;
    }
    ...
    public void async_set_t4(List<DateTime[]> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packListType("value",value,DateTime[].class);
    rr_async_PropertySet("t4",m,new rrend_async_set_t4(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t4 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t5(Action2<List<DateTime[]>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t5",new rrend_async_get_t5(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t5 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<DateTime[]>,RuntimeException> rr_handler=(Action2<List<DateTime[]>,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t5(List<DateTime[]> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<DateTime[]>packListType("value",value,DateTime[].class);
    rr_async_PropertySet("t5",m,new rrend_async_set_t5(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t5 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t6(Action2<List<MultiDimArray>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t6",new rrend_async_get_t6(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t6 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<MultiDimArray>,RuntimeException> rr_handler=(Action2<List<MultiDimArray>,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t6(List<MultiDimArray> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<MultiDimArray>packListType("value",value,MultiDimArray.class);
    rr_async_PropertySet("t6",m,new rrend_async_set_t6(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t6 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t7(Action2<Duration,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t7",new rrend_async_get_t7(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t7 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<Duration,RuntimeException> rr_handler=(Action2<Duration,RuntimeException>)param;
    if (err!=null)
    {
    rr_handler.action(new Duration(0,0),err);
    return;
    }
    Duration rr_ret;
    try {
    rr_ret=(MessageElementUtil.<Duration[]>castDataAndDispose(value))[0];
    } catch (RuntimeException err2) {
    rr_handler.action(new Duration(0,0),err2);
    return;
    }
    rr_handler.action(rr_ret,null);
    }
    }
    public void async_set_t7(Duration value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packArray("value",new Duration[] {value});
    rr_async_PropertySet("t7",m,new rrend_async_set_t7(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t7 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t8(Action2<Duration[],RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t8",new rrend_async_get_t8(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t8 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<Duration[],RuntimeException> rr_handler=(Action2<Duration[],RuntimeException>)param;
    if (err!=null)
    ...
    Duration[] rr_ret;
    try {
    rr_ret=MessageElementUtil.<Duration[]>unpackArray(value);
    } catch (RuntimeException err2) {
    rr_handler.action(null,err2);
    return;
    }
    ...
    public void async_set_t8(Duration[] value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packArray("value",value);
    rr_async_PropertySet("t8",m,new rrend_async_set_t8(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t8 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t9(Action2<MultiDimArray,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t9",new rrend_async_get_t9(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t9 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<MultiDimArray,RuntimeException> rr_handler=(Action2<MultiDimArray,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t9(MultiDimArray value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.packMultiDimArray("value",(MultiDimArray)value);
    rr_async_PropertySet("t9",m,new rrend_async_set_t9(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t9 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t10(Action2<List<Duration[]>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t10",new rrend_async_get_t10(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t10 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<Duration[]>,RuntimeException> rr_handler=(Action2<List<Duration[]>,RuntimeException>)param;
    if (err!=null)
    {
    rr_handler.action(null,err);
    return;
    }
    List<Duration[]> rr_ret;
    try {
    rr_ret=MessageElementUtil.<Duration[]>unpackListType(value);
    } catch (RuntimeException err2) {
    rr_handler.action(null,err2);
    return;
    }
    ...
    public void async_set_t10(List<Duration[]> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packListType("value",value,Duration[].class);
    rr_async_PropertySet("t10",m,new rrend_async_set_t10(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t10 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t11(Action2<List<Duration[]>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t11",new rrend_async_get_t11(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t11 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<Duration[]>,RuntimeException> rr_handler=(Action2<List<Duration[]>,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t11(List<Duration[]> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<Duration[]>packListType("value",value,Duration[].class);
    rr_async_PropertySet("t11",m,new rrend_async_set_t11(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t11 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
    ...
    public void async_get_t12(Action2<List<MultiDimArray>,RuntimeException> rr_handler, int rr_timeout)
    {
    rr_async_PropertyGet("t12",new rrend_async_get_t12(),rr_handler,rr_timeout);
    }
    protected class rrend_async_get_t12 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement value ,RuntimeException err,Object param)
    {
    Action2<List<MultiDimArray>,RuntimeException> rr_handler=(Action2<List<MultiDimArray>,RuntimeException>)param;
    if (err!=null)
    ...
    public void async_set_t12(List<MultiDimArray> value, Action1<RuntimeException> rr_handler, int rr_timeout)
    {
    MessageElement m=null;
    try {
    m=MessageElementUtil.<MultiDimArray>packListType("value",value,MultiDimArray.class);
    rr_async_PropertySet("t12",m,new rrend_async_set_t12(),rr_handler,rr_timeout);
    }
    finally {
    if (m!=null) m.delete();
    }
    }
    protected class rrend_async_set_t12 implements Action3<MessageElement,RuntimeException,Object> {
    public void action(MessageElement m ,RuntimeException err,Object param)
    {
    Action1<RuntimeException> rr_handler=(Action1<RuntimeException>)param;
    if (err!=null)
