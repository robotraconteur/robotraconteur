...
public class obj4_stub extends ServiceStub implements obj4, async_obj4 {
    public obj4_stub(WrappedServiceStub innerstub) {
        super(innerstub); 
    }
    ...
    return (com.robotraconteur.testing.TestService1.sub3)findObjRefTyped("o3_1",String.valueOf(ind),"com.robotraconteur.testing.TestService1.sub3");
    }
    ...
    public void async_get_o3_1(String ind, Action2<com.robotraconteur.testing.TestService1.sub3,RuntimeException> handler, int timeout) {
