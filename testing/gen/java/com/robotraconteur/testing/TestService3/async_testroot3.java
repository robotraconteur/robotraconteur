...
public interface async_testroot3
{
    ...
    void async_get_t1(Action2<DateTime,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t1(DateTime value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t2(Action2<DateTime[],RuntimeException> rr_handler, int rr_timeout);
    void async_set_t2(DateTime[] value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t3(Action2<MultiDimArray,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t3(MultiDimArray value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t4(Action2<List<DateTime[]>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t4(List<DateTime[]> value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t5(Action2<List<DateTime[]>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t5(List<DateTime[]> value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t6(Action2<List<MultiDimArray>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t6(List<MultiDimArray> value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t7(Action2<Duration,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t7(Duration value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t8(Action2<Duration[],RuntimeException> rr_handler, int rr_timeout);
    void async_set_t8(Duration[] value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t9(Action2<MultiDimArray,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t9(MultiDimArray value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t10(Action2<List<Duration[]>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t10(List<Duration[]> value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t11(Action2<List<Duration[]>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t11(List<Duration[]> value, Action1<RuntimeException> rr_handler, int rr_timeout);
    void async_get_t12(Action2<List<MultiDimArray>,RuntimeException> rr_handler, int rr_timeout);
    void async_set_t12(List<MultiDimArray> value, Action1<RuntimeException> rr_handler, int rr_timeout);
