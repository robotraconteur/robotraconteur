...
public class vectorptr_wrappedservicesubscriptionnode extends java.util.AbstractList<WrappedServiceSubscriptionFilterNode> implements java.util.RandomAccess {
  ...
  private int doCapacity() {
    return RobotRaconteurJavaJNI.vectorptr_wrappedservicesubscriptionnode_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    RobotRaconteurJavaJNI.vectorptr_wrappedservicesubscriptionnode_doReserve(swigCPtr, this, n);
  }
