...
public class WrappedServiceStub extends RRObject {
  ...
  public boolean setRRDirector(WrappedServiceStubDirector director, int id) {
    return RobotRaconteurJavaJNI.WrappedServiceStub_setRRDirector(swigCPtr, this, WrappedServiceStubDirector.getCPtr(director), director, id);
  }

  public WrappedDirectorLock getRRDirectorLock() {
    long cPtr = RobotRaconteurJavaJNI.WrappedServiceStub_getRRDirectorLock(swigCPtr, this);
    return (cPtr == 0) ? null : new WrappedDirectorLock(cPtr, true);
  }
