...
public class vectorptr_subscriptionclientid extends java.util.AbstractList<WrappedServiceSubscriptionClientID> implements java.util.RandomAccess {
  ...
  private int doCapacity() {
    return RobotRaconteurJavaJNI.vectorptr_subscriptionclientid_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    RobotRaconteurJavaJNI.vectorptr_subscriptionclientid_doReserve(swigCPtr, this, n);
  }
