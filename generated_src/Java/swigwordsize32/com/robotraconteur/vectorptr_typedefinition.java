...
public class vectorptr_typedefinition extends java.util.AbstractList<TypeDefinition> implements java.util.RandomAccess {
  ...
  private int doCapacity() {
    return RobotRaconteurJavaJNI.vectorptr_typedefinition_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    RobotRaconteurJavaJNI.vectorptr_typedefinition_doReserve(swigCPtr, this, n);
  }
