...
public class vectorptr_memberdefinition extends java.util.AbstractList<MemberDefinition> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(vectorptr_memberdefinition obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
...
public MemberDefinition doGet(int i)
{
  ...
  private int doCapacity() {
    return RobotRaconteurJavaJNI.vectorptr_memberdefinition_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    RobotRaconteurJavaJNI.vectorptr_memberdefinition_doReserve(swigCPtr, this, n);
  }
