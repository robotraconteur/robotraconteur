...
class BrowserWebSocketTransport(Transport):
    ...
    def __init__(self, *args):
        _RobotRaconteurPython.BrowserWebSocketTransport_swiginit(self, _RobotRaconteurPython.new_BrowserWebSocketTransport(*args))

    def _GetDefaultReceiveTimeout(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDefaultReceiveTimeout(self)

    def _SetDefaultReceiveTimeout(self, milliseconds):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDefaultReceiveTimeout(self, milliseconds)

    def _GetDefaultConnectTimeout(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDefaultConnectTimeout(self)

    def _SetDefaultConnectTimeout(self, milliseconds):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDefaultConnectTimeout(self, milliseconds)

    def _GetDefaultHeartbeatPeriod(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDefaultHeartbeatPeriod(self)

    def _SetDefaultHeartbeatPeriod(self, milliseconds):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDefaultHeartbeatPeriod(self, milliseconds)

    def GetUrlSchemeString(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport_GetUrlSchemeString(self)

    def _GetDisableMessage4(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDisableMessage4(self)

    def _SetDisableMessage4(self, d):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDisableMessage4(self, d)

    def _GetDisableStringTable(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDisableStringTable(self)

    def _SetDisableStringTable(self, d):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDisableStringTable(self, d)

    def _GetDisableAsyncMessageIO(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetDisableAsyncMessageIO(self)

    def _SetDisableAsyncMessageIO(self, d):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetDisableAsyncMessageIO(self, d)

    def _GetMaxMessageSize(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport__GetMaxMessageSize(self)

    def _SetMaxMessageSize(self, size):
        return _RobotRaconteurPython.BrowserWebSocketTransport__SetMaxMessageSize(self, size)

    def GetServerListenUrls(self):
        return _RobotRaconteurPython.BrowserWebSocketTransport_GetServerListenUrls(self)
    ...
    __swig_destroy__ = _RobotRaconteurPython.delete_BrowserWebSocketTransport

# Register BrowserWebSocketTransport in _RobotRaconteurPython:
_RobotRaconteurPython.BrowserWebSocketTransport_swigregister(BrowserWebSocketTransport)
