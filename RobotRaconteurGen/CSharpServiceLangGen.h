...
namespace RobotRaconteurGen
{
	...
	public:
		...
		static void GenerateCStructure(RR_SHARED_PTR<ServiceEntryDefinition> e, ostream* w);

		static void GenerateAStructureExtensions(RR_SHARED_PTR<ServiceEntryDefinition> e, ostream * w);
