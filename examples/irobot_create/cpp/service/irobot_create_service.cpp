...
class Create_impl : public c3::Create_default_impl, public boost::enable_shared_from_this<Create_impl>
{
  public:
    ...
    void Init(std::string port)
    {
        ...
        std::vector<uint8_t> start_cmd = {128, 132, 150, 0, 139, 0, 80, 255};
    ...
    void Shutdown()
    {
        ...
        std::vector<uint8_t> stop_cmd = {128};
    ...
    void StartStreaming()
    {
        ...
        std::vector<uint8_t> command = {148, 1, 6};
    ...
    void StopStreaming()
    {
        ...
        std::vector<uint8_t> command = {150, 0};
        boost::asio::write(*serial_port, boost::asio::buffer(command));
    }
    ...
    void setf_leds(RR::rr_bool play, RR::rr_bool advance) override
    {
        ...
        std::vector<uint8_t> command = {139, bits, 80, 255};
        boost::asio::write(*serial_port, boost::asio::buffer(command));
    }
  ...
  protected:
    ...
    void Play()
    {
        ...
        try
        {
            ...
            std::vector<uint8_t> command = {140, 0, (uint8_t)(notes->size() / 2)};
