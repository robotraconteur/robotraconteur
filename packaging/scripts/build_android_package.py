...
with zipfile.ZipFile('distfiles/RobotRaconteurCoreAndroid-v1(%s).aar' % ver_str, 'w', zipfile.ZIP_DEFLATED) as zip:
    zip.write('robotraconteur/packaging/android_aar/AndroidManifest.xml', arcname = "AndroidManifest.xml")
    ...
    zip.write(f'{asset_dir}/out-android-x86_64/Java/RobotRaconteurAndroid.jar', arcname = 'libs/RobotRaconteurAndroid.jar')
