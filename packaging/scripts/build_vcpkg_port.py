...
req = urllib.request.Request(tarball_url, headers={"Accept": "application/octet-stream", "Authorization": f"token {token}"})
...
template_dict = {"VERSION": ver, "VERSION_REF": ref, "TARBALL_SHA512": tarball_sha512}
