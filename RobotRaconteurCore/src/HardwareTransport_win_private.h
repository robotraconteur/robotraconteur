...
#define DEVPROP_TYPE_STRING     0x00000012
	...
	typedef	BOOL(WINAPI *SetupDiGetDeviceInterfacePropertyW_t)(HDEVINFO DeviceInfoSet, PSP_DEVICE_INTERFACE_DATA DeviceInterfaceData, CONST DEVPROPKEY *PropertyKey, DEVPROPTYPE *PropertyType, PBYTE PropertyBuffer, DWORD PropertyBufferSize, PDWORD RequiredSize, DWORD Flags);
	typedef HDEVINFO(WINAPI* SetupDiGetClassDevsW_t)(CONST GUID *ClassGuid, PCWSTR Enumerator, HWND hwndParent, DWORD Flags);
	typedef BOOL(WINAPI* SetupDiDestroyDeviceInfoList_t)(HDEVINFO DeviceInfoSet);
	typedef BOOL(WINAPI* SetupDiEnumDeviceInterfaces_t)(HDEVINFO DeviceInfoSet, PSP_DEVINFO_DATA DeviceInfoData, CONST GUID *InterfaceClassGuid, DWORD MemberIndex, PSP_DEVICE_INTERFACE_DATA DeviceInterfaceData);
	typedef BOOL(WINAPI* SetupDiGetDeviceInterfaceDetailW_t)(HDEVINFO DeviceInfoSet, PSP_DEVICE_INTERFACE_DATA DeviceInterfaceData, PSP_DEVICE_INTERFACE_DETAIL_DATA_W DeviceInterfaceDetailData, DWORD DeviceInterfaceDetailDataSize, PDWORD RequiredSize, PSP_DEVINFO_DATA DeviceInfoData);
...
#define SETUPAPI_FUNCTIONS_PTR_INIT(t) t = (t ## _t)GetProcAddress(hLibModule, #t); if (t == NULL) return false; 
...
#pragma pack()
	...
	typedef BOOL (__stdcall* WinUsb_GetAssociatedInterface_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR AssociatedInterfaceIndex, PWINUSB_INTERFACE_HANDLE AssociatedInterfaceHandle);
	typedef BOOL (__stdcall* WinUsb_GetDescriptor_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR DescriptorType, UCHAR Index, USHORT LanguageID,	PUCHAR Buffer, ULONG BufferLength, PULONG LengthTransferred);
	typedef BOOL (__stdcall* WinUsb_QueryInterfaceSettings_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR AlternateInterfaceNumber, PUSB_INTERFACE_DESCRIPTOR UsbAltInterfaceDescriptor);
	typedef BOOL (__stdcall* WinUsb_QueryDeviceInformation_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, ULONG InformationType, PULONG BufferLength, PVOID Buffer);
	typedef BOOL (__stdcall* WinUsb_SetCurrentAlternateSetting_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR SettingNumber);
	typedef BOOL (__stdcall* WinUsb_GetCurrentAlternateSetting_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, PUCHAR SettingNumber);
	typedef BOOL (__stdcall* WinUsb_QueryPipe_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR AlternateInterfaceNumber, UCHAR PipeIndex, PWINUSB_PIPE_INFORMATION PipeInformation);
	typedef BOOL (__stdcall* WinUsb_QueryPipeEx_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR AlternateSettingNumber, UCHAR PipeIndex, PWINUSB_PIPE_INFORMATION_EX PipeInformationEx);
	typedef BOOL (__stdcall* WinUsb_SetPipePolicy_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, ULONG PolicyType, ULONG ValueLength, PVOID Value);
	typedef BOOL (__stdcall* WinUsb_GetPipePolicy_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, ULONG PolicyType, PULONG ValueLength, PVOID Value);
	typedef BOOL (__stdcall* WinUsb_ReadPipe_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, PUCHAR Buffer, ULONG BufferLength, PULONG LengthTransferred, LPOVERLAPPED Overlapped);
	typedef BOOL (__stdcall* WinUsb_WritePipe_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, PUCHAR Buffer, ULONG BufferLength, PULONG LengthTransferred, LPOVERLAPPED Overlapped);
	typedef BOOL (__stdcall* WinUsb_ControlTransfer_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, WINUSB_SETUP_PACKET SetupPacket, PUCHAR Buffer, ULONG BufferLength, PULONG LengthTransferred, LPOVERLAPPED Overlapped);
	...
	typedef BOOL (__stdcall* WinUsb_SetPowerPolicy_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, ULONG PolicyType, ULONG ValueLength,PVOID Value);
	typedef BOOL (__stdcall* WinUsb_GetPowerPolicy_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, ULONG PolicyType, PULONG ValueLength, PVOID Value);
	typedef BOOL (__stdcall* WinUsb_GetOverlappedResult_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, LPOVERLAPPED lpOverlapped, LPDWORD lpNumberOfBytesTransferred, BOOL bWait);
	typedef BOOL (__stdcall* WinUsb_GetCurrentFrameNumber_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, PULONG CurrentFrameNumber, LARGE_INTEGER *TimeStamp);
	typedef BOOL (__stdcall* WinUsb_GetAdjustedFrameNumber_t)(PULONG CurrentFrameNumber, LARGE_INTEGER TimeStamp);
	typedef BOOL (__stdcall* WinUsb_RegisterIsochBuffer_t)(WINUSB_INTERFACE_HANDLE InterfaceHandle, UCHAR PipeID, PUCHAR Buffer, ULONG BufferLength, PWINUSB_ISOCH_BUFFER_HANDLE IsochBufferHandle);
	typedef BOOL (__stdcall* WinUsb_UnregisterIsochBuffer_t)(WINUSB_ISOCH_BUFFER_HANDLE IsochBufferHandle);
	typedef BOOL (__stdcall* WinUsb_WriteIsochPipe_t)(WINUSB_ISOCH_BUFFER_HANDLE BufferHandle, ULONG Offset, ULONG Length, PULONG FrameNumber, LPOVERLAPPED Overlapped);
	typedef BOOL (__stdcall* WinUsb_ReadIsochPipe_t)(WINUSB_ISOCH_BUFFER_HANDLE BufferHandle, ULONG Offset, ULONG Length, PULONG FrameNumber, ULONG NumberOfPackets, PUSBD_ISO_PACKET_DESCRIPTOR IsoPacketDescriptors, LPOVERLAPPED Overlapped);
	typedef BOOL (__stdcall* WinUsb_WriteIsochPipeAsap_t)(WINUSB_ISOCH_BUFFER_HANDLE BufferHandle, ULONG Offset, ULONG Length, BOOL ContinueStream, LPOVERLAPPED Overlapped);
	typedef BOOL (__stdcall* WinUsb_ReadIsochPipeAsap_t)(WINUSB_ISOCH_BUFFER_HANDLE BufferHandle, ULONG Offset, ULONG Length, BOOL ContinueStream, ULONG NumberOfPackets, PUSBD_ISO_PACKET_DESCRIPTOR IsoPacketDescriptors, LPOVERLAPPED Overlapped);
...
#define WINUSB_FUNCTIONS_PTR_INIT(t) t = (t ## _t)GetProcAddress(hLibModule, #t); if (t == NULL) return false; 
...
{
public:
	WinUsbDevice_Initialize(RR_SHARED_PTR<UsbDevice> parent, RR_SHARED_PTR<WinUsb_Functions> f, const UsbDeviceManager_detected_device& detected_device);
...
public:
	...
	WinUsbDevice_Claim(RR_SHARED_PTR<UsbDevice> parent, RR_SHARED_PTR<WinUsb_Functions> f, const UsbDeviceManager_detected_device& detected_device);
...
public:
	...
	WinUsbDevice(RR_SHARED_PTR<WinUsbDeviceManager> parent, RR_SHARED_PTR<WinUsb_Functions> f, const UsbDeviceManager_detected_device& device);
...
class HardwareTransport_win_discovery : public HardwareTransport_discovery<WinUsbDeviceManager, WinsockBluetoothConnector>
{
public:

	
	HardwareTransport_win_discovery(RR_SHARED_PTR<HardwareTransport> parent, const std::vector<std::string>& schemes, RR_SHARED_PTR<WinUsbDeviceManager> usb, RR_SHARED_PTR<WinsockBluetoothConnector> bt, RR_SHARED_PTR<void> f_void);
