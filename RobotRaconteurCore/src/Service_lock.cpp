...
namespace RobotRaconteur
{
	...
	std::string ServerContext_ObjectLock::GetUsername() const
	{
		return m_Username;
	}

	bool ServerContext_ObjectLock::IsLocked() const
	{
		return m_Locked;
	}

	std::string ServerContext_ObjectLock::GetRootServicePath() const
	{
		return m_RootServicePath;
	}

	uint32_t ServerContext_ObjectLock::GetEndpoint() const
	{
		return m_Endpoint;
	}
	...
	bool ServerContext_MonitorObjectSkel::IsLocked() const
	{
		return monitor_acquired;
	}
	...
	std::string ServerContext_MonitorObjectSkel::MonitorEnter(uint32_t local_endpoint, int32_t timeout)
	{
...

		{
			...
			if (!s) throw InvalidOperationException("Object lost");
