...
namespace asio
{
    ...
    {
        double interval = ((double)(time - boost::posix_time::microsec_clock::universal_time()).total_microseconds())*1e-3;
    ...
    void deadline_timer::async_wait(boost::function<void(boost::system::error_code)> f)
    {
        ...
        timer = boost::make_shared<RobotRaconteur::WallTimer>(boost::posix_time::microseconds(interval), [f](const RobotRaconteur::TimerEvent& ev)
        {
