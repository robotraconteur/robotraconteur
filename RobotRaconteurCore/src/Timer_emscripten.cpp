...
namespace RobotRaconteur
{
	...
	WallTimer::WallTimer(const boost::posix_time::time_duration& period, boost::function<void (const TimerEvent&)> handler, bool oneshot, const RR_SHARED_PTR<RobotRaconteurNode>& node) 
	{
		this->period=period;
...
void WallRate::Sleep()
{
    throw std::runtime_error("Rate not supported for single threaded emscripten");
}
}