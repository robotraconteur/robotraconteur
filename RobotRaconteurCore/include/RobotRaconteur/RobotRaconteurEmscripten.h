...
namespace boost
{
    ...
    template<typename T> using unique_lock=null_lock<T>;
    template<typename T> using shared_lock=null_lock<T>;
    template<typename T> using upgrade_lock=null_lock<T>;
    template<typename T> using upgrade_to_unique_lock=null_lock<T>;
