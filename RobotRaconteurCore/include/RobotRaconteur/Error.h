...
namespace RobotRaconteur
{
	...
	public:
		 ...
		 */
		RobotRaconteurException(MessageErrorType ErrorCode, const std::string &error, const std::string &message, std::string sub_name, RR_INTRUSIVE_PTR<RRValue> param);
...
#define RR_EXCEPTION_DECL_1(exp_cpp_type, exp_code, exp_type_str) \
	...
	{ \
	public: \
		exp_cpp_type(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>()); \
	}; \
...
#define RR_EXCEPTION_DECL_2(exp_cpp_type, exp_code) \
	...
	{ \
	public: \
		exp_cpp_type(const std::string &error, const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>()); \
...
#undef RR_EXCEPTION_DECL_2
	...
	public:
		 ...
		 */
		ConnectionException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ProtocolException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ServiceNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ObjectNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		InvalidEndpointException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		EndpointCommunicationFatalException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		NodeNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ServiceException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		MemberNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		MemberFormatMismatchException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		DataTypeMismatchException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		DataTypeException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		DataSerializationException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		MessageEntryNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		MessageElementNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		UnknownException(const std::string &error, const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		InvalidOperationException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		InvalidArgumentException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		OperationFailedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		NullValueException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		InternalErrorException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		PermissionDeniedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		SystemResourcePermissionDeniedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		OutOfSystemResourceException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		SystemResourceException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ResourceNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		IOException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		BufferLimitViolationException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ServiceDefinitionException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		OutOfRangeException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		...
		KeyNotFoundException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		RobotRaconteurRemoteException(const std::string &error, const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		RequestTimeoutException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ReadOnlyMemberException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		WriteOnlyMemberException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		NotImplementedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		MemberBusyException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ValueNotSetException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		AuthenticationException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		ObjectLockedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		AbortOperationException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
	...
	public:
		 ...
		 * @param param_ Optional error param
		 */
		OperationAbortedException(const std::string &message, std::string sub_name = "", RR_INTRUSIVE_PTR<RRValue> param_ = RR_INTRUSIVE_PTR<RRValue>());
