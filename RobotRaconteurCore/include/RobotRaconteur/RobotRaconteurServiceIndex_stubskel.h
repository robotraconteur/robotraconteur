...
class ServiceIndex_skel : public virtual RobotRaconteur::ServiceSkel
{
  public:
    ...
    RR_OVIRTUAL RR_SHARED_PTR<RobotRaconteur::RRObject> GetSubObj(boost::string_ref name, boost::string_ref ind) RR_OVERRIDE ;
    ...
    RR_OVIRTUAL RR_INTRUSIVE_PTR<RobotRaconteur::MessageEntry> CallMemoryFunction(
        const RR_INTRUSIVE_PTR<RobotRaconteur::MessageEntry>& m, const RR_SHARED_PTR<RobotRaconteur::Endpoint>& e) RR_OVERRIDE ;
