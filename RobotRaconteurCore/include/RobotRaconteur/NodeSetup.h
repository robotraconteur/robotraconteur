...
namespace RobotRaconteur
{
	...
	public:
		...
		/**
		 * @brief Construct a new ServerNodeSetup and initialize the singleton RobotRaconteurNode without command line options
		 *  
		 * Configures RobotRaconteurNode::s() and manages its lifecycle
		 * 
		 * service_types may be `ROBOTRACONTEUR_SERVICE_TYPES` if "robotraconteur_generated.h" is included.
	...
	public:
		...
		/**
		 * @brief Construct a new SecureServerNodeSetup and initialize specified RobotRaconteurNode without command line options
		 *  
		 * service_types may be `ROBOTRACONTEUR_SERVICE_TYPES` if "robotraconteur_generated.h" is included.
		 * 
		 * @param node The node to configure and manage lifecycle
		...
		/**
		 * @brief Construct a new SecureServerNodeSetup and initialize the singleton RobotRaconteurNode without command line options
		 *  
		 * Configures RobotRaconteurNode::s() and manages its lifecycle
		 * 
		 * service_types may be `ROBOTRACONTEUR_SERVICE_TYPES` if "robotraconteur_generated.h" is included.
		...
		/**
		 * @brief Construct a new SecureServerNodeSetup and initialize specified RobotRaconteurNode with command line options
		 *  
		 * service_types may be `ROBOTRACONTEUR_SERVICE_TYPES` if "robotraconteur_generated.h" is included.
		 * 
		 * See \ref command_line_options for more information on available command line options.
		...
		/**
		 * @brief Construct a new SecureServerNodeSetup and initialize the singleton RobotRaconteurNode with command line options
		 *  
		 * service_types may be `ROBOTRACONTEUR_SERVICE_TYPES` if "robotraconteur_generated.h" is included.
		 * 
		 * See \ref command_line_options for more information on available command line options.
