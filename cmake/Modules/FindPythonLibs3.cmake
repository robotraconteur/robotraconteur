...
#   PYTHONLIBS3_VERSION_STRING  - version of the Python libs found (since CMake 2.8.8)
#
#
#
...
foreach(_CURRENT_VERSION ${_Python3_VERSIONS})
  ...
  if(PYTHON3_LIBRARY)
    ...
    # PYTHON3_LIBRARY may contain a list because of SelectLibraryConfigurations
  ...
  if(PYTHON3_INCLUDE_DIR AND EXISTS "${PYTHON3_INCLUDE_DIR}/patchlevel.h")
    ...
    string(REGEX REPLACE "^#define[ \t]+PY_VERSION[ \t]+\"([^\"]+)\".*" "\\1"
                         PYTHONLIBS3_VERSION_STRING "${python_version_str}")
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(PythonLibs3
