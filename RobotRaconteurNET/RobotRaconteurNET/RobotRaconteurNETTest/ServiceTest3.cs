...
namespace RobotRaconteurNETTest
{
    ...
    public class RobotRaconteurTestServiceSupport3
    {
        ...
        public void RegisterServices()
        {
            ...
            var context = RobotRaconteurNode.s.RegisterService("RobotRaconteurTestService3", "com.robotraconteur.testing.TestService5", testservice3);
        }
    ...
    public class asynctestroot_impl : asynctestroot_default_impl, async_asynctestroot
    {
        ...
        public Task<Generator1<teststruct4,teststruct5>> async_f6(double a,int rr_timeout=RobotRaconteurNode.RR_TIMEOUT_INFINITE)
        {
            throw new NotImplementedException("");
        }
